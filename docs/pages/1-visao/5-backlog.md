...
| US03 | EP01 | Controlar Permissão | Como administrador, quero restringir os direitos de interação da área privada entre os diferentes cargos disponíveis para manter a segurança de utilização. |
...
| US11 | EP03 | Visualizar dados de produtividade da equipe | Como advogado, quero visualizar dados de produtividade da equipe em um painel com relação às interações das atividades para analisar o serviço dos meus advogados. |
| US12 | EP03 | Visualizar revisão geral do estado das atividades | Como advogado, quero visualizar em um painel a revisão geral da quantidade de atividades pendentes, concluídas e atrasadas para tomar decisões estratégicas. |
| US13 | EP04 | Gerenciar Processos | Como usuário autorizado, quero gerenciar processos da advocacia, para centralizar os dados em um único local. |
...
| US15 | EP04 | Visualizar resumo geral de processos | Como advogado, quero visualizar em um painel um resumo geral de processos em andamento, com etapas em atrasos e finalizados para tomar decisões estratégicas. |
| US16 | EP04 | Visualizar lista de processos em estado crítico | Como advogado, quero visualizar uma lista gerada automaticamente pelo sistema com os processos sem registro de movimentação recente para não perder prazos. |
